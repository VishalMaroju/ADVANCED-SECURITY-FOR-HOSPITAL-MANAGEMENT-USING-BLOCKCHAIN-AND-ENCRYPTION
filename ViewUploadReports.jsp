...
<section class="container">
    <div class="form-container">
        <h3 class="form-title">Patient Upload Reports</h3>
        <table class="w3-table" style="width: 100%; text-align: center; font-size: 16px; border-collapse: collapse;">
            <thead>
                <tr style="background-color: #007bff; color: white;">
                    <th style="border: 1px solid #ddd;">FILE ID</th>
                    <th style="border: 1px solid #ddd;">PATIENT ID OR MAIL ID</th>
                    <th style="border: 1px solid #ddd;">DOWNLOAD REPORT</th>
                </tr>
            </thead>
            <tbody>
                <%
                ...
                while (itr.hasNext()) {
                    ...
                    String patientIdOrMailId = itr.next();
                    String downloadLink = itr.next(); // Assuming the next item is the download link
                %>
                    <tr style="color: black;">
                        <td style="border: 1px solid #ddd;"><%= fileId %></td>
                        <td style="border: 1px solid #ddd;"><%= patientIdOrMailId %></td>
                        <td style="border: 1px solid #ddd;">
                            <a href="Download1?da=<%= downloadLink %>" class="button-lg bg-indigo-lightest-20 indigo-lightest focus-black fw-300 fs-s3 mr-0 br-l-0">DOWNLOAD</a>
                        </td>
                    </tr>
                <% } %>
            </tbody>
