...
<section class="container">
    <div class="form-container">
        <h3 class="form-title">Register as Patient</h3>
     	<form action="PateintRegister" method="post">
                <div>
                 <label for="PatientName">PATIENT NAME :</label>
                <input type="text"
                       
                        placeholder="Enter Patient Name" name="PatientName" required> 
                        <br>
                         <label for="PatientID">PATIENT ID :</label>
                    <input type="text"
                       
                        placeholder="Enter Patient ID" name="PatientID" required> 
                        <br>
                        ...
                        placeholder="Enter Confirm Password" name="PatientCPassword" oniput="validateForm()" required> 
						<br>
						 <label for="PatientMobile">PATIENT MOBILE NO:</label>
                        <input type="text"
                       
                        placeholder="Enter Patient Contact" name="PatientMobile" oninput="validateMobileNumber(this)" required>
                        <br>
                        <label for="PatientCountry">PATIENT COUNTRY:</label>
                    <input type="text"
                        
                        placeholder="Enter Patient Country" name="PatientCountry" required>
						<br>
						 <label for="PatientCity">PATIENT CITY :</label>
                        <input type="text"
                        
                        placeholder="Enter Patient City" name="PatientCity" required>
						<br>
						 <label for="PatientAddress">PATIENT ADDRESS :</label>
                        <input type="text"
                       
                        placeholder="Enter Patient Address" name="PatientAddress" required> 
                        <br>
                         <label for="PatientPincode">PATIENT PINCODE :</label>
                        <input type="text"
                        
                        placeholder="Enter Patient Pincode" name="PatientPincode" required> 
                        <br>
