			...
			<div class="row align-items-center">
				<div class="col-lg-6">
					<ul class="top-bar-info list-inline-item pl-0 mb-0">
						...
						<li class="list-inline-item"><i class="icofont-location-pin mr-2"></i>Somajiguda besides Yashooda hospital,Hyderabad </li>
					</ul>
				</div>
				<div class="col-lg-6">
		...
		<div class="row">
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<p class="mb-4 pr-5">Malicious insiders may tamper,
steal or change patients’ health data, which results in a loss of patient trust in these systems.</p>
				...
				<div class="feature-block d-lg-flex">
					...
					<div class="feature-item mb-5 mb-lg-0">
						...
						<ul class="w-hours list-unstyled">
		                    <li class="d-flex justify-content-between">Mon - Wed : <span>10:00 - 17:00</span></li>
		...
		<div class="row justify-content-center">
			<div class="col-lg-7 text-center">
				<div class="section-title">
					...
					<p>In this work, we practically implement a web application
		...
		<div class="row align-items-center">
			<div class="col-lg-6 ">
				<div class="appoinment-content">
					<img src="images/about/img-3.jpg" alt="" class="img-fluid">
					<div class="emergency">
						<h2 class="text-lg"><i class="icofont-phone-circle text-lg"></i>+919581022022</h2>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-4 mr-auto col-sm-6">
				<div class="widget mb-5 mb-lg-0">
					...
					<p>We evaluate the system’s security and performance under varying numbers of patients and actions.</p>
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="widget widget-contact mb-5 mb-lg-0">
					...
					<div class="footer-contact-block">
						...
						<h4 class="mt-2"><a href="tel:+23-345-67890">+91 9581022022</a></h4>
					</div>
				</div>
			</div>
		</div>
