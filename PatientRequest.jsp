...
<section class="container">
    <div class="form-container">
        <h3 class="form-title">Patient Appointment Request</h3>
        <table class="w3-table w3-blue" style="width: 100%; text-align: center; font-size: 16px; border-collapse: collapse;" border="1">
            <thead>
            ...
            <tbody>
                ...
                while (al.next()) { %>
                    <tr style="color: black;">
                        ...
                        <td><a href="ApproveByDoctor?email=<%= al.getString(2) %>" class="approve-link">APPROVE</a></td>
                    </tr>
                <% } %>
            </tbody>
        </table>
