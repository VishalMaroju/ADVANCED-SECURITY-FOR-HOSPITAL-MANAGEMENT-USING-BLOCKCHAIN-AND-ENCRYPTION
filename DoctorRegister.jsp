...
<section class="container">
    <div class="form-container">
        <h3 class="form-title">Register as Doctor</h3>
     	<form action="DoctorRegister" method="post">
           ...
           <input type="password"
            ...
            <input type="number" placeholder="Enter Mobile" name="mobile" required oninput="validateMobileNumber(this)" />
            ...
            <select name="DHighestDegree" required>
            ...
            <select name="DSpecialization" required>
            ...
            <input type="text" placeholder="Enter Doctor Experience" name="DExperience" required>
            
            <label for="DRegistrationNumber">DOCTOR REGISTRATION NO :</label>
            <input type="text" placeholder="Enter Doctor Registration Number" name="DRegistrationNumber" required>
            
            <label for="StateMedicalCouncil">DOCTOR MEDICAL COUNCIL COMPLETED :</label>
            <select name="StateMedicalCouncil" required>
                <option value="">Select Council</option>
                <option value="State">State</option>
                <!--  <option value="Central">Central</option> -->
                <option value="Foreign">Abroad</option>
                <option value="Other">Other</option>
            </select>
