...
<section class="container">
    <div class="form-container">
        <form action="UploadMedicineServlet" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="medicinePhoto">Upload Medicine Photo</label>
                <input type="file" class="form-control" id="medicinePhoto" name="medicinePhoto" accept="image/*" required>
            </div>
