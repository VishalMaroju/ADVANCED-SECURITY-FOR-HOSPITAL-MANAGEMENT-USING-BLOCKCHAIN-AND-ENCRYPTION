...
<section class="container">
    <div class="form-container">
        <h3 class="form-title">Upload Reports</h3>
        <h1 class="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900 ">LIVE Message</h1>
                <br><br>
             <a href="Compose1.jsp" class="button-lg bg-indigo-lightest-20 indigo-lightest focus-white fw-300 fs-s3 mr-0 br-l-0 custom-btn">SENDING MESSAGE</a>

              <br><br>
              <a href="Inbox1.jsp" class="button-lg bg-indigo-lightest-20 indigo-lightest focus-white fw-300 fs-s3 mr-0 br-l-0 custom-btn">RECEIVE MESSAGE</a>
