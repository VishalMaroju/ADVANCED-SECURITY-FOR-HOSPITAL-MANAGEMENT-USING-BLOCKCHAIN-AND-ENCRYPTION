    ...
    <div class="container">
        <div class="registration-form">
            ...
            <form action="HospitalLogin" method="post">
                ...
                <input type="text" placeholder="Enter Hospital ID" name="uid" required>

                <label for="password">Password</label>
                <input type="password" placeholder="Enter Hospital Password" name="pwd" required>

                <center>
                    <input type="submit" class="btn-login" value="Login" />
                    <input type="reset" class="btn-login" value="Reset" />
                    <br>
                    <a href="HospitalRegister.jsp" class="btn-new-hospital">New Hospital</a>
                    <br>
                    <a href="HospitalForgotPassword.jsp" class="btn-new-hospital">Forgot Password?</a>
                </center>
            </form>
        </div>
    </div>
