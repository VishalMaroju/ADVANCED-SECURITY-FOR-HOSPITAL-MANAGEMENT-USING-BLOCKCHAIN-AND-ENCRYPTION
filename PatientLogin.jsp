...
<section class="container">
    <div class="form-container">
        <h3 class="form-title">Login as Patient</h3>
        <form action="PatientLogin" method="post">
            ...
            <div class="links">
                <a href="PatientRegister.jsp" class="button-link">New Patient</a>
                <a href="PatientForgotpassword.jsp" class="button-link">Forgot Password?</a>
            </div>
        </form>
